                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div :class="isLoading ? 'canvas-form-opacity' : 'canvas-form' ">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Simple Recapitulation Debt Apps</div>
                        ...
                        <div>
                            ...
                            <InputText id="email1" v-model="login.username" type="text" placeholder="Username | Email" class="w-full md:w-[30rem] mb-8" />
    
                            <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Password</label>
                            <Password id="password1" v-model="login.password" placeholder="Password" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>
